...
if (isset($_POST['kirim'])) {
    ...
    mysqli_query($connect, "INSERT INTO buku(kode, kategori_id, nama_buku, harga, stok, penerbit_id) VALUES ('$kode','$kategori','$nama_buku', $harga, $stok, '$penerbit')");
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="penerbit" aria-label="Default select example">
                                        <option value=""></option>
                                        <?php
                                        $penerbit = mysqli_query($connect, "SELECT * FROM penerbit");
                                        foreach ($penerbit as $pen) {
                                        ?>
                                            <option value="" name="penerbit"><?= $pen['nama'] ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-10">
                                    <button type="submit" name="kirim" class="btn btn-primary"><i class="bi bi-save"></i> Simpan</button>
                                </div>
                            </div>
                        </form>
                    </div>
