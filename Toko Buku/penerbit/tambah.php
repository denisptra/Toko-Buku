...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($connect, "INSERT INTO penerbit (kode, nama, alamat, kota, telepon) VALUES ('$kode','$nama','$alamat','$kota',$telepon)");
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Tambah Data Penerbit</h5>
                        <form method="post">
                            <div class="row mb-3">
